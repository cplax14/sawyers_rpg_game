      ...
      <div className={`bg-white dark:bg-gray-800 rounded-lg shadow p-4 ${className}`}>
        ...
        <div className={`flex items-center ${isCompact ? 'space-x-3' : 'space-x-4'}`}>
          ...
          <div className='flex-1 min-w-0'>
            <div
              className={`font-medium text-gray-900 dark:text-white truncate ${isCompact ? 'text-sm' : 'text-base'}`}
            >
              {displayName}
            </div>
            {!isCompact && (
            ...
            <div className='flex items-center mt-1'>
              {user.emailVerified ? (
                <span
                  className={`inline-flex items-center px-2 py-0.5 rounded-full bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-300 ${isCompact ? 'text-xs' : 'text-xs'}`}
                >
