...
export const AuthenticationModal: React.FC<AuthenticationModalProps> = ({
  ...
  const { signIn, signUp, sendPasswordReset, isLoading, error: authError, clearError } = useAuth();
    ...
    >
      <div className='bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md mx-4 p-6'>
        ...
        <div className='flex justify-between items-center mb-6'>
          <h2 className='text-2xl font-bold text-gray-900 dark:text-white'>{modalContent.title}</h2>
          <button
            onClick={onClose}
