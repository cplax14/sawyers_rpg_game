...
export const EnemySwoopAnimation: React.FC<EnemySwoopProps> = React.memo(
  ({
    ...
    const renderCreature = (size: number) => {
      ...
      return (
        <svg width={size} height={size} viewBox='0 0 40 40' style={baseStyle}>
          {/* Wings */}
          <ellipse cx='10' cy='20' rx='8' ry='12' fill={impactColors[0]} opacity='0.8' />
          <ellipse cx='30' cy='20' rx='8' ry='12' fill={impactColors[0]} opacity='0.8' />
          {/* Body */}
          <ellipse cx='20' cy='20' rx='6' ry='10' fill={impactColors[1]} />
          {/* Head */}
          <circle cx='20' cy='15' r='4' fill={impactColors[1]} />
        </svg>
      );
    };
