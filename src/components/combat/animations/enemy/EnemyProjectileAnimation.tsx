...
export const EnemyProjectileAnimation: React.FC<EnemyProjectileProps> = React.memo(({
  ...
  const midY = finalTrajectory === 'arc'
  ...
  useEffect(() => {
    const transitions = [
      ...
      { delay: WINDUP_DURATION + LAUNCH_DURATION + TRAVEL_DURATION, nextPhase: 'impact' as const }
    ];
