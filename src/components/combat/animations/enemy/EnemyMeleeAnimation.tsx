  ...
  ({
    ...
    useEffect(() => {
      const transitions = [
        ...
        {
          delay: RAISE_DURATION + HOLD_DURATION + SWING_DURATION + IMPACT_DURATION,
          nextPhase: 'recovery' as const,
        },
      ];
        ...
        case 'fist':
          return (
            <svg
              ...
              height={size * 0.6}
              viewBox='0 0 20 20'
              style={{ ...baseStyle, width: size * 0.6, height: size * 0.6 }}
            >
          ...
          <>
            ...
            <motion.div
              ...
              style={{
                ...
                top: targetY,
                width:
                  config.impactSize === 'large' ? 70 : config.impactSize === 'medium' ? 50 : 40,
                height:
                  config.impactSize === 'large' ? 70 : config.impactSize === 'medium' ? 50 : 40,
                marginLeft:
                  config.impactSize === 'large' ? -35 : config.impactSize === 'medium' ? -25 : -20,
                marginTop:
                  config.impactSize === 'large' ? -35 : config.impactSize === 'medium' ? -25 : -20,
                borderRadius: '50%',
            ...
            <ParticleSystem
              ...
              originY={targetY}
              particleCount={
                config.impactSize === 'large' ? 20 : config.impactSize === 'medium' ? 15 : 12
              }
            ...
            {(weaponType === 'sword' || weaponType === 'axe' || weaponType === 'claw') && (
              <motion.div
                ...
                style={{
                  ...
                  transform:
                    finalSwingPattern === 'horizontal' ? 'rotate(-20deg)' : 'rotate(-70deg)',
