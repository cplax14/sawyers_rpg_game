...
const ReactUI: React.FC = () => {
  ...
  return (
    <div className='react-ui-overlay'>
      ...
      <div
        id='character-select'
        className={`screen ${currentScreen === 'character_select' ? 'active' : ''}`}
      >
        <CharacterSelection />
      </div>
      ...
      <div id='game-world' className={`screen ${currentScreen === 'game_world' ? 'active' : ''}`}>
        ...
        >
          ...
          >
            ...
            <p
              id='area-description'
              style={{ color: 'var(--parchment)', marginBottom: '15px' }}
            ></p>
            <div id='area-buttons' style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
              <button id='travel-to-area' className='btn primary' type='button'>
                Travel Here
              </button>
              <button id='explore-area' className='btn primary' type='button'>
                Explore Area
              </button>
              <button id='center-map' className='btn secondary' type='button'>
                Center Map
              </button>
            </div>
          </div>
          ...
          >
            <button id='back-from-world' className='btn secondary' type='button'>
              ← Back to Menu
            </button>
          </div>
        </div>
      ...
      <div
        id='combat'
        className={`screen ${currentScreen === 'combat' || reactGameState.currentScreen === 'combat' ? 'active' : ''}`}
      >
        <ReactCombat />
      </div>
      ...
      <div
        ...
        className={`screen ${currentScreen === 'monster_management' ? 'active' : ''}`}
      >
        ...
        <div className='monster-management-placeholder'>
          ...
          <div
            className='monster-buttons'
            style={{ margin: '20px', display: 'flex', gap: '10px', flexWrap: 'wrap' }}
          >
            <button id='heal-all-btn' className='btn primary' type='button'>
              Heal All
            </button>
            <button id='auto-arrange-btn' className='btn primary' type='button'>
              Auto Arrange
            </button>
            <button id='release-selected-btn' className='btn danger' type='button'>
              Release Selected
            </button>
            <button id='sort-storage-btn' className='btn secondary' type='button'>
              Sort Storage
            </button>
            <button id='start-breeding-btn' className='btn primary' type='button'>
              Start Breeding
            </button>
            <button id='clear-breeding-btn' className='btn secondary' type='button'>
              Clear Breeding
            </button>
            <button id='back-from-monsters' className='btn secondary' type='button'>
              Back
            </button>
          </div>
          <div className='monster-modal' id='monster-modal' style={{ display: 'none' }}>
            <button id='monster-modal-close' className='btn secondary' type='button'>
              Close
            </button>
            <button id='modal-add-to-party' className='btn primary' type='button'>
              Add to Party
            </button>
            <button id='modal-remove-from-party' className='btn secondary' type='button'>
              Remove from Party
            </button>
            <button id='modal-release-monster' className='btn danger' type='button'>
              Release Monster
            </button>
          </div>
        </div>
      ...
      <div
        id='inventory'
        className={`screen ${currentScreen === 'inventory' || reactGameState.currentScreen === 'inventory' ? 'active' : ''}`}
      >
