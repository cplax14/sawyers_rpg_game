...
jest.mock('../atoms/SkeletonCard', () => ({
  SkeletonCard: ({ type }: any) => <div data-testid={`skeleton-${type}`}>Loading...</div>,
}));
...
describe('LazyVirtualizedGrid', () => {
  ...
  const mockRenderItem = jest.fn((item, index) => (
    <div data-testid={`rendered-item-${index}`}>{item ? item.name : 'Loading...'}</div>
  ));
  ...
  describe('Rendering', () => {
    ...
    it('should render custom skeleton when renderSkeleton is provided', () => {
      ...
      render(<LazyVirtualizedGrid {...defaultProps} renderSkeleton={customRenderSkeleton} />);
  ...
  describe('Lazy Loading Integration', () => {
    it('should call loadFunction with correct parameters', () => {
      ...
      render(<LazyVirtualizedGrid {...defaultProps} pageSize={50} preloadDistance={2} />);
    ...
    it('should call onScroll prop when provided', () => {
      ...
      render(<LazyVirtualizedGrid {...defaultProps} onScroll={mockOnScroll} />);
  ...
  describe('Configuration', () => {
    it('should use different skeleton types', () => {
      ...
      rerender(<LazyVirtualizedGrid {...defaultProps} skeletonType='equipment' />);
    ...
    it('should apply custom styles and className', () => {
      ...
      render(
        <LazyVirtualizedGrid {...defaultProps} style={customStyle} className={customClassName} />
      );
