...
export const QuotaManagementDialog: React.FC<QuotaManagementDialogProps> = ({
  ...
  const handleNotificationAction = useCallback((action: string, notificationId: string, data?: any) => {
    switch (action) {
      case 'cleanup':
                ...
                {quotaStatus && quotaStatus.saveBreakdown.length > 0 && (
                  <div>
                        ...
                        <div
                          ...
                          style={{
                            ...
                            background: selectedSavesToDelete.has(save.slotNumber) ?
                              'rgba(255, 107, 107, 0.2)' : 'rgba(255, 255, 255, 0.05)',
                            borderRadius: '6px',
                            marginBottom: '4px',
                            cursor: 'pointer'
                          }}
                        ...
                        >
                          ...
                          <div style={{ flex: 1 }}>
                            ...
                            <div style={{
                              ...
                              {save.createdAt.toLocaleDateString()} • {formatBytes(save.sizeBytes)}
                            </div>
                          </div>
                        </div>
                      ))}
                    ...
                    <div style={{ display: 'flex', gap: '8px' }}>
                      ...
                      >
                        {isPerformingCleanup ? 'Deleting...' : `Delete ${selectedSavesToDelete.size} saves`}
                      </Button>
                      <Button
                        variant="ghost"
