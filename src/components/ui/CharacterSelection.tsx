  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className='character-classes-grid'
          style={{
            display: 'grid',
        ...
        >
          {Object.entries(CHARACTER_CLASSES).map(([classKey, classData]) => (
            ...
            >
              ...
              >
                <div style={{ color: 'var(--blood-red)' }}>❤️ HP: {classData.baseStats.hp}</div>
                <div style={{ color: 'var(--ice-blue)' }}>💧 MP: {classData.baseStats.mp}</div>
        ...
        <div
          className='character-selection-buttons'
          style={{
            display: 'flex',
            gap: '1rem',
