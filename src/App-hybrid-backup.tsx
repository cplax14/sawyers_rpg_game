    ...
    <div id="ui-overlay" style={{ display: 'none' }}>
      ...
      <div id="story-modal" className="hidden">
        ...
        <div className="modal-content">
          <header className="modal-header">
            ...
            <button className="modal-close" id="story-close">✕</button>
          </header>
      ...
      <div id="game-hud" className="hidden">
        <div className="hud-section player-stats">
          <div className="stat">Level: <span id="player-level">1</span></div>
          <div className="stat">HP: <span id="player-hp">100</span>/<span id="player-max-hp">100</span></div>
          <div className="stat">MP: <span id="player-mp">50</span>/<span id="player-max-mp">50</span></div>
          <div className="stat">Gold: <span id="player-gold">0</span></div>
        </div>

        <div className="hud-section action-buttons">
          <button id="world-map-btn" className="btn hud">Map</button>
          <button id="monsters-btn" className="btn hud">Monsters</button>
          <button id="inventory-btn" className="btn hud">Inventory</button>
          <button id="save-game-btn" className="btn hud">Save</button>
        </div>
      </div>
    </div>
  );
