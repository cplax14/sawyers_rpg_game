...
- Brand style guide in `/docs/context/style-guide.md`
...
3. **Verify design compliance** - Compare against `/docs/context/rpg_design_principles.md` and `/docs/context/style_guide.md`
